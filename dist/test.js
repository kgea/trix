...
class TrixEditorElement extends HTMLElement {
  constructor() {
    ...
    _classPrivateFieldSet(this, _internals, this.attachInternals());
  }
...
_defineProperty(TrixEditorElement, "formAssociated", true);
...
testGroup("integrates with its <form>", {
  ...
  test$3("adds [disabled] attribute based on .disabled property", () => {
    const editor = document.getElementById("editor-with-ancestor-form");
  ...
  test$3("removes [contenteditable] and disables input when editor element has [disabled]", () => {
    const editor = document.getElementById("editor-with-no-form");
  ...
  test$3("removes [contenteditable] and disables input when editor element is :disabled", () => {
  ...
  test$3("does not receive focus when :disabled", () => {
  ...
  test$3("disabled editor does not encode its value when the form is submitted", () => {
    const editor = document.getElementById("editor-with-ancestor-form");
